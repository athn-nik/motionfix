...
def slerp_poses(last_pose, new_pose, number_of_frames, pose_rep="matrix"):
    # interpolation
    from src.tools.easyconvert import to_matrix, matrix_to
...
def align_interpolate(rotations, translation, s, e, align_rot=True, align_trans=True, interpolate=True):
    ...
    from src.tools.interpolation import align_orientations, interpolate_track, linear_interp
...
def align_orientations(s, e, poses_interp, transl):
    ...
    # starting from j
    # remove the rotation
    from src.tools.geometry import matrix_to_axis_angle, axis_angle_to_matrix
